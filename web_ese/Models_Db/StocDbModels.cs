	...
	public class StocDbModels : DatabaseConnection
	{
		...
		public MemoryStream GetStocListExcel(StocListModels model)
		{
			...
			using (ExcelPackage excelPackage = new ExcelPackage())
			{
				...
				int col = 1;
				// 첫줄
				workSheet.Cells[row, col++].Value = "번호";  
				workSheet.Cells[row, col++].Value = "SEQNO";
				workSheet.Cells[row, col++].Value = getNationCol;
				workSheet.Cells[row, col++].Value = "EST_NAME";
				workSheet.Cells[row, col++].Value = "EST_CODE";	//삭제?
				workSheet.Cells[row, col++].Value = "CATE";     //삭제?
				workSheet.Cells[row, col++].Value = getCateCol;
				workSheet.Cells[row, col++].Value = "BARCODE";
				workSheet.Cells[row, col++].Value = "PRODUCT_NAME";
				workSheet.Cells[row, col++].Value = "BRAND";
				workSheet.Cells[row, col++].Value = "IN_CNT";
				workSheet.Cells[row, col++].Value = "OUT_CNT";
				workSheet.Cells[row, col++].Value = "BAD_CNT";
				workSheet.Cells[row, col++].Value = "CHANGE_CNT";
				workSheet.Cells[row, col++].Value = "STOC_CNT";
				workSheet.Cells[row, col++].Value = "EXP_OUT_CNT";
				workSheet.Cells[row, col++].Value = "EXP_STOC_CNT";
